namespace WebApiSample01.Migrations
{
    ...
    public partial class ValidationAdded : DbMigration
    {
        ...
        {
            AlterColumn("dbo.Quotes", "Title", c => c.String(nullable: false, maxLength: 10));
            AlterColumn("dbo.Quotes", "Author", c => c.String(nullable: false, maxLength: 10));
            AlterColumn("dbo.Quotes", "Description", c => c.String(nullable: false, maxLength: 25));
