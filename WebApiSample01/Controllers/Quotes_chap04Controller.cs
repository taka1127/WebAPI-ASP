...
{
    public class Quotes_chap04Controller : ApiController
    {
        QuotesDbContext quotesDbContext = new QuotesDbContext();

        //// GET: api/Quotes_chap04
        //public IEnumerable<Quote> GetTest()
        //{
        ...
        // GET: api/Quotes_chap04
        [HttpGet]
        public IEnumerable<Quote> TestGet()
        {
            return quotesDbContext.Quotes;
        }

        [HttpGet]
        [Route("api/Quotes_chap04/Test/{id}")]
        public int Test(int id)
        {
            return id;
        }

        // GET: api/Quotes_chap04/5
